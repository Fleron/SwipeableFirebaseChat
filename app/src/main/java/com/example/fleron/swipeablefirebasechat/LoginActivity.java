package com.example.fleron.swipeablefirebasechat;

/**
 * Created by fleron on 2016-10-31.
 */
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginInputEmail.setText("emil.fleron@gmail.com");
        loginInputPassword = (EditText) findViewById(R.id.login_input_password);
        loginInputPassword.setText("emilnor32");
        ...
        btnLinkToSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(com.example.fleron.swipeablefirebasechat.LoginActivity.this, SignupActivity.class);
